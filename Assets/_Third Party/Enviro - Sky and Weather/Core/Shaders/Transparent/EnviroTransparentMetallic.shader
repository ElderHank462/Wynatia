Shader "Enviro/StandardAlphaBlended_Metallic"
{
	Properties
	{
		...
		_Metallic ("Metallic Tex (R)", 2D) = "white" {}
		_MetallicIntensity ("Metallic", Range(0,1)) = 1.0
	}
	SubShader
	{
		...
		void surf (Input IN, inout SurfaceOutputStandard o)
		{
			...
			o.Metallic =  metal.rgb * _MetallicIntensity;
